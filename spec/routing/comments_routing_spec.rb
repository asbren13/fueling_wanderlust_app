...
RSpec.describe 'routes for comments' do
  ...
  it 'routes POST /cities/:city_id/suggestions/:suggestion_id/comments to the comments controller' do
    expect(post('/cities/1/suggestions/1/comments')).to route_to('comments#create', city_id: "1", suggestion_id:"1")
  end
 it 'routes GET /cities/1/suggestions/1/comments/1 to the suggestions controller' do
